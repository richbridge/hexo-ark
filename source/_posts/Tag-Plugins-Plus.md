...
{% referfrom '[1]','Richの梵刹群聊简介','https://jq.qq.com/?_wv=1027&k=pGLB2C0N' %}
...
<!-- tab 示例源码 -->
```markdown
Richの梵刹(akilar.top)是一个私人性质的博客{% referto '[1]','Richの梵刹群聊简介' %}，从各类教程至生活点滴，无话不谈。建群的目的是提供一个闲聊的场所。博客采用Hexo框架{% referto '[2]','Hexo中文文档' %}，Butterfly主题{% referto '[3]','Butterfly 安装文档(一) 快速开始' %}
